...
public class V1000_01 extends AutoUpgradeTemplate {
    ...
    protected void process() throws Exception {
        AutoScriptUtil.createOrUpdateScript(con, "STAUTOSCRIPT.ZEBRALABEL.LABELCFG", "psdi/zebralabel/en/resources/stautoscript.zebralabel.labelcfg.js","Barcode Label Configurations", "1.0.0", dbIn);
        ...
        AutoScriptUtil.createOrUpdateScript(con, "STAUTOSCRIPT.ZEBRALABEL.PRINTERCFG", "psdi/zebralabel/en/resources/stautoscript.zebralabel.printercfg.js","Barcode Printer Configurations", "1.0.0", dbIn);
